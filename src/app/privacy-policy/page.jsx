...
export default function PrivacyPolicy() {
  return (
    <main style={{maxWidth: 700, margin: '0 auto', padding: '2rem'}}>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TVPro Handy Service LLC, 641 W Crosstimbers Street, Apt 506, Houston, TX 77018.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to TVPro Handy Service, accessible from <a href="tvprousa.com" rel="external nofollow noopener" target="_blank">tvprousa.com</a></p>
        </li>
        <li>
