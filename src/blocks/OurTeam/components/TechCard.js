...
const TargetIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>;
const ToolsIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>;
...
const HeartIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>;
const VerifiedCheckIcon = () => <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>;
...
const TechCard = ({ tech, cityName = "your area" }) => {
  ...
  const hasValidPhoto = mediaObj && mediaObj.url && !mediaObj.url.includes('placeholder.png');
  ...
  const speedReliability = tech.signature || "Always on time, always professional.";
  const howIHelp = tech.whyRemember || tech.motto || null;
  const blueStatValue = tech.jobsCount || "100+ Projects";
  const blueStatLabel = "Completed";
    ...
    <div className={styles.techCard}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.attributesList}>
          {whatILove && (
            <div className={styles.attributeItem}>
              <div className={styles.attributeIcon}><TargetIcon /></div>
          ...
          {specializesIn && (
            <div className={styles.attributeItem}>
              <div className={styles.attributeIcon}><ToolsIcon /></div>
              <div className={styles.attributeText}>
          ...
          {experience && (
            <div className={styles.attributeItem}>
              <div className={styles.attributeIcon}><ClockIcon /></div>
              <div className={styles.attributeText}>
          ...
          {speedReliability && (
            <div className={styles.attributeItem}>
              <div className={styles.attributeIcon}><ShieldIcon /></div>
              <div className={styles.attributeText}>
                <span className={styles.attributeLabel}>Speed & Reliability</span>
                <span className={styles.attributeValue}>{speedReliability}</span>
              </div>
            </div>
          )}
          {howIHelp && (
            <div className={styles.attributeItem}>
              <div className={styles.attributeIcon}><HeartIcon /></div>
              <div className={styles.attributeText}>
        ...
        <div className={styles.blueStatBlock}>
          <div className={styles.blueStatIcon}><CheckCircleIcon /></div>
