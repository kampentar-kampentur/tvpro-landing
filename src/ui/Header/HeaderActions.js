            ...
            <div className={styles.cta}>
                {isBlog && (
                    <div className={styles.blogWidgets}>
                        ...
                        <div ref={searchRef} className={`${styles.searchContainer} ${searchOpen ? styles.searchOpen : ""}`}>
                            <form onSubmit={handleSearchSubmit} className={`${styles.searchForm} ${searchOpen ? styles.searchFormExpanded : ""}`}>
                                <input 
                                    type="text" 
                            ...
                            {searchOpen && searchQuery.trim().length >= 3 && (
                                <div className={styles.searchSuggestionsCard}>
                                    ...
                                    {searchError && (
                                        <div className={`${styles.suggestionsState} ${styles.suggestionsStateError}`}>
                                    ...
                                    {!searchLoading && !searchError && suggestions.length === 0 && (
                                        <div className={styles.suggestionsState}>
                                            <span>No articles found matching &quot;{searchQuery}&quot;</span>
                                        </div>
                                    )}
                                            ...
                                            <ul className={styles.suggestionsList}>
                                                {suggestions.map((post) => (
                                                    <li key={post.slug} className={styles.suggestionItem}>
                                                        ...
                                                        >
                                                            <span className={styles.suggestionCategory}>{post.category}</span>
                                                            <span className={styles.suggestionTitle}>{post.title}</span>
                                                        </Link>
                                                    </li>
                                                ))}
                                            </ul>
