...
export default function HeaderActions({ isBlog, isHome, isVariantB }) {
  const cta = useCTA();
      ...
      <div className={styles.cta}>
        {isBlog && (
          <div className={styles.blogWidgets}>
            ...
            <a href="/" className={styles.mobileHomeCircle} aria-label="Go to Main Site">
        ...
        <Button
          ...
          className={isVariantB ? styles.headerPhoneBtnB : styles.phoneMobileHide}
          aria-label={`Call ${cta?.phoneLabel || "TVPro"}`}
        >
          {isVariantB && (
            <svg
              className={styles.phoneIconB}
              width="18"
              height="18"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <span className={isVariantB ? styles.phoneLabelB : ""}>
        ...
        <QuoteButton
          size="small"
          modalName="BookNow"
          className={isVariantB ? styles.quoteBtnB : ""}
        >
          Book Now
        </QuoteButton>
        <label
